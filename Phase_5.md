...
* Triton FlashAttention：
  - 序列越长，性能越高，但在大序列长度下，性能趋于稳定，说明主要瓶颈已从访存转向计算资源
  - 没有 OOM，具备良好的可扩展性
  - **结论**：Triton FlashAttention 成功将 attention 从 memory-bound 转化为 compute-bound，是性能和可扩展性的关键提升

> 若算子仍受访存限制，随着序列长度增加，吞吐率通常不会提升甚至可能下降。而这里，性能先随序列长度增长，然后在大序列下进入平台区，表明该算子先是因算术强度提高而性能提升，撞到计算墙后，瓶颈转变为 compute-bound，从而进入平台区。
